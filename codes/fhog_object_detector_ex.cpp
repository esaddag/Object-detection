...
{  
    ...
    try
    {
        ...
        // file.
        load_image_dataset(images_train, face_boxes_train, "../../training.xml");
        load_image_dataset(images_test, face_boxes_test, "../../testing.xml");
        ...
        scanner.set_detection_window_size(30, 100); 
        ...
        deserialize("object_detector.svm") >> detector2;
